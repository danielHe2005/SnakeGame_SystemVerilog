...
# ACDS 17.0 595 win32 2025.05.23.21:32:30
# ----------------------------------------
...
# ----------------------------------------
# If CLOCK25_PLL is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "CLOCK25_PLL"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CLOCK25_PLL.vo"
}
